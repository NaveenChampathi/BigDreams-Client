    ...
    return (
      <div className={classes.container}>
        ...
        <div className={classes.valuesContainer}>
          ...
          <div className={parseInt(pnl) > 0 ? classes.green : classes.red}>
            {parseInt(pnl)}
          </div>
...
const BackTesting = () => {
  ...
  const [maxPercentageLossPerTrade, setMaxPercentageLossPerTrade] =
    useState(60);
  const [
    minOpenToPremarketHighPercentage,
    setMinOpenToPremarketHighPercentage,
  ] = useState(0);
  const [
    maxOpenToPremarketHighPercentage,
    setMaxOpenToPremarketHighPercentage,
  ] = useState(0);
  const [maxPremarketSpikingPercentage, setMaxPremarketSpikingPercentage] =
    useState(0);
  const [minPremarketSpikingPercentage, setMinPremarketSpikingPercentage] =
    useState(0);
  const [chartData, setChartData] = useState([]);
  const [summary, setSummary] = useState({});

  const runBackTest = () => {
    const { summary, chartData } = backTest({
      minPremarketVolume,
      maxPremarketVolume,
      openPrice,
            ...
            <div className={classes.parametersContainer}>
              ...
              <div className={classes.parameterField}>
                <TextField
                  ...
                  onChange={(e) =>
                    setAmountToInvestPerTrade(parseFloat(e.target.value))
                  }
                  value={amountToInvestPerTrade}
                />
              </div>
              ...
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Min. Premarket Volume"
                  onChange={(e) =>
                    setMinPremarketVolume(parseFloat(e.target.value))
                  }
              ...
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Max. Premarket Volume"
                  onChange={(e) =>
                    setMaxPremarketVolume(parseFloat(e.target.value))
                  }
              ...
              <div className={classes.parameterField}>
                <TextField
                  ...
                  onChange={(e) =>
                    setMaxPercentageLossPerTrade(parseFloat(e.target.value))
                  }
                  value={maxPercentageLossPerTrade}
                />
              </div>
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Min. open to Premarket high percentage"
                  onChange={(e) =>
                    setMinOpenToPremarketHighPercentage(
                      parseFloat(e.target.value)
                    )
                  }
                  value={minOpenToPremarketHighPercentage}
                />
              </div>
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Max. open to Premarket high percentage"
                  onChange={(e) =>
                    setMaxOpenToPremarketHighPercentage(
                      parseFloat(e.target.value)
                    )
                  }
                  value={maxOpenToPremarketHighPercentage}
                />
              </div>
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Min. Premarket spiking percentage"
                  onChange={(e) =>
                    setMinPremarketSpikingPercentage(parseFloat(e.target.value))
                  }
                  value={minPremarketSpikingPercentage}
                />
              </div>
              <div className={classes.parameterField}>
                <TextField
                  id="standard-basic"
                  label="Max. Premarket spiking percentage"
                  onChange={(e) =>
                    setMaxPremarketSpikingPercentage(parseFloat(e.target.value))
                  }
                  value={maxPremarketSpikingPercentage}
                />
              </div>
            </div>
